...
i havet vid stranden flyter tusentals döda skal av myggor och andra insekter - någotför breach space hulk?


Zobmies:
zombi is a state, of the spieces that can be affected (robots will be immune and we might introduce some other immune species too)

they inherit the attributes of the individual they infect - a strong person will become a strong zombie, same with size, speed etc
...
What is a good name for bestiary? I mean, i want a book, like the ones i saw as a kid with all the monsters in a roleplaying game

but we shall also include human enemies etc
It's meant to be a handbook for us, we can look at when we create missions

Let me note down the units i intended for the first mission


the mission is also described in 